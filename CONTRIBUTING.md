...
Project Atlas is deliberately small so a human or coding agent can fork it and turn it into a different Remote MCP App.

1. Create a focused branch.
2. Run `pnpm dev` and make the complete handshake visible in the local playground.
...
6. Explain any capability-contract change in the pull request.
